  ...
  pipeline: {
    ...
    voice: {
      ...
      closingBlock: {
        ...
        subheading: {
          en: "What this AI story actually means at street level in Tokyo.",
          ja: "このニュースは、東京の暮らしに何をもたらすか。"
        },
        outputKey: "tokyo_take",
        rules:
          "This block is the magazine's PLAIN-LANGUAGE EXPLAINER of the AI / tech news for non-experts living in Tokyo — written so that a 10-year-old in Setagaya and a 60-year-old in Sugamo can both read it and walk away understanding what actually happened and what it means for them.\n\nNO jargon without a parenthetical translation. Avoid 'AI ecosystem', 'paradigm shift', 'leveraging', 'transformative', 'next-generation', 'API', 'LLM', 'SaaS' unless you immediately gloss them in the same sentence. Address the reader directly. In Japanese use です・ます (warm explainer register) even though the body uses 常体. In English use plain, direct second person.\n\nThe block MUST answer these FOUR questions in order, in 4–6 paragraphs per language, each question taking roughly one paragraph:\n\n(1) WHAT HAPPENED, IN PLAIN WORDS — Re-explain the news as if to someone who has never used ChatGPT and doesn't know what a model, an API, or a SaaS is. Use real-world analogies (a translator who never sleeps; a notebook that types itself; a recorder that remembers every word from yesterday's meeting). This is a TRANSLATION of the news into kitchen-table Japanese, not a summary.\n\n(2) DOES THIS CHANGE LIFE IN TOKYO YET? — Be concrete. Will the convenience-store cashier notice? The school teacher in Nerima? The salaryman commuting from Saitama? The grandmother arranging a hospital visit? The Akihabara indie dev? If the honest answer is 'no, not yet — this is mostly for engineers in San Francisco', say that plainly. If the honest answer is 'yes, the Japanese signup is open today and it works in Japanese on a Japanese phone number', say THAT plainly. Name a specific everyday Tokyo situation.\n\n(3) WHEN WILL IT REACH JAPAN — Give an actual timeframe with a reason. Examples: 'It will arrive once the Japanese language model is fine-tuned, probably within 6 months'; 'It will not arrive at all unless a Japanese partner licenses it — see how Notta did with PLAUD'; 'It is already here — search for it on the Japanese App Store today'. Don't hedge. If the timeline is unknown, name the specific gating factor (Japanese language support / payment in JPY / regulatory approval / a domestic partnership).\n\n(4) JAPANESE EQUIVALENT — Name a SPECIFIC Japanese company, organization, or product already doing something comparable. Choose accurately from: ELYZA, Sakana AI, Preferred Networks, PLAUD, Notta, LINE WORKS, freee, Money Forward, Mercari, Cookpad, NTT, SoftBank, Rakuten, the University of Tokyo Matsuo Lab, METI's GENIAC program, JETRO, JIDF, or a clearly relevant alternative. Do NOT force a name — if no Japanese equivalent exists, say so plainly and name the closest adjacent player and what gap remains.\n\nTone: warm, concrete, useful. Imagine you are explaining this story over coffee to your aunt who reads the Asahi Shimbun every morning but has never heard of GitHub. NO empty patriotism. NO defeatism. NO 'in conclusion' / 'in summary' wrap-up sentences — end on a concrete observation, not a tidy closing."
      }
    }
  },
